...
import { mentors } from "./mentors_data.mjs";
...
export default async(message) => {
  ...
  if (message.content.match(/Day1車割！/)) {
    await message.reply(`チーム紫：もりね,りじ,ゴゴティー,うらっしゅ,ほなみん,わたみ,アンビ\n`+`チーム黄色：みるく,きゃあ。,ばく,あづき,ネンネン,しろ,やまゆ\n`+`チーム緑：KURO,あるが,ほのぴ,ゆちゃ,はたこー,ねお,きぺお\n` + `チームピンク：ゆわ,ほしょ,もーりー,あいりす,まさぴ〜,まんじ,ばんしぃ\n` + `チーム赤：ヨヨギ,きょーりゅー,きほもり,すしろー,ひらけー！,りっちゃん,ようる\n` + `チームオレンジ：まっすー,zenzen,さとたい,ニュイ,ひかぴ,あおぽん\n` + `チーム青：きゃんた,ゆるゆる,キノヤ,はるちろ,まぽこ,chanまい\n`);
  }
  ...
  if (message.content.match(/昼ごはん！/)) {
    ...
    await message.reply("ついにFlacation mnkmが始めるしゃみ〜！！始まった感のある写真を見てみたいしゃみ！");
  }
  ...
  if (message.content.match(/アレルギー！/)) {
    await message.reply(`アレルギーはこんな感じしゃみ！気をつけてしゃみ〜！\n` +
      `エビ,貝類(ホタテなど),生のトマト,なす,もも,りんご,きゅうり,メロン,すいか,生えび,キウイ,とろろ\n`
    );
  }
